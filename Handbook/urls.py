...
urlpatterns = [
    path('device-type-l/', views.DeviceTypeListAPIView.as_view(), name = 'devicetype_l'),
    path('device-type-r/<int:id>/', views.DeviceTypeRetrieveAPIView.as_view(), name = 'devicetype_r'),
    ...
    path('device-maker-l/', views.DeviceMakerListAPIView.as_view(), name = 'devicemaker_l'),
    path('device-maker-r/<int:id>/', views.DeviceMakerRetrieveAPIView.as_view(), name = 'devicemaker_r'),
    ...
    path('device-model-l/', views.DeviceModelListAPIView.as_view(), name = 'device_model_l'),
    path('device-model-r/<int:id>/', views.DeviceModelRetrieveAPIView.as_view(), name = 'device_model_r'),
    ...
    path('device-kit-l/', views.DeviceKitListAPIView.as_view(), name = 'device_kit_l'),
    path('device-kit-r/<int:id>/', views.DeviceKitRetrieveAPIView.as_view(), name = 'device_kit_r'),
    ...
    path('device-appearance-l/', views.DeviceAppearanceListAPIView.as_view(), name = 'device_appearance_l'),
    path('device-appearance-r/<int:id>/', views.DeviceAppearanceRetrieveAPIView.as_view(), name = 'device_appearance_r'),
    ...
    path('device-defect-l/', views.DeviceDefectListAPIView.as_view(), name = 'device_defect_l'),
    path('device-defect-r/<int:id>/', views.DeviceDefectRetrieveAPIView.as_view(), name = 'device_defect_r'),
    ...
    path('service-price-l/', views.ServicePriceListAPIView.as_view(), name = 'service_price_l'),
    path('service-price-r/<int:id>/', views.ServicePriceRetrieveAPIView.as_view(), name = 'service_price_r'),
