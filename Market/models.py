...
class Product(MainMixin):
    ...
    barcode = models.CharField(
        max_length=150, null=True, verbose_name='Barcode')
    purchase_price = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                                         MinValueValidator(0.0)], verbose_name='Purchase price')
    sale_price = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                                     MinValueValidator(0.0)], verbose_name='Sale price')
    count = models.IntegerField(verbose_name='Quantity')
    supplier = models.CharField(max_length=150, verbose_name='Supplier')
    irreducible_balance = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                                              MinValueValidator(0.0)], verbose_name='Irreducible balance')
...
class Cashbox(MainMixin):
    name = models.CharField(max_length=150, verbose_name='Name')
    cash = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                               MinValueValidator(0.0)], verbose_name='Cash')
    account_money = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                                        MinValueValidator(0.0)], verbose_name='Account money')
...
class PurchaseRequest(MainMixin):
    price = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                                MinValueValidator(0.0)], verbose_name='Price')
    count = models.IntegerField(verbose_name='Quantity')
...
class SaleProduct(MainMixin):
    cash = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                               MinValueValidator(0.0)], verbose_name='Cash')
    card = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                               MinValueValidator(0.0)], verbose_name='Card')
    bank_transfer = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                                        MinValueValidator(0.0)], verbose_name='Bank transfer')
    discount = models.DecimalField(max_digits=100, decimal_places=2, validators=[
                                   MinValueValidator(0.0)], verbose_name='Discount')

    client = models.ForeignKey(ClientCard, on_delete=models.SET_NULL,
                               related_name='client_card_sale_product', null=True, verbose_name='ClientCard')
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE,
...
class SaleOrder(MainMixin):
    ...
    client = models.ForeignKey(ClientCard, on_delete=models.SET_NULL,
                               related_name='client_card_sale_order', null=True, verbose_name='ClientCard')
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE,
    ...
    def __str__(self):
        return f'id: {self.id} | organization: {self.organization.id} | cashbox: {self.cashbox.id} cash: {self.cash} card: {self.card} | bank_transfer: {self.bank_transfer} | discount: {self.discount}'
...
class WorkDone(MainMixin):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE,
                                     related_name='organization_work_done', verbose_name='Organization')
    service_price = models.ForeignKey(ServicePrice, on_delete=models.SET_NULL,
                                      related_name='service_price_work_done', null=True, verbose_name='ServicePrice')
...
class ProductOrder(MainMixin):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE,
                                     related_name='organization_product_order', verbose_name='Organization')
    ...
    def __str__(self):
        return f'id: {self.id} | price: {self.price} | organization: {self.organization.id} | product: {self.product}'
...
class Transaction(MainMixin):
    cashbox = models.ForeignKey(Cashbox, on_delete=models.PROTECT,
                                related_name='cashbox_transaction', verbose_name='Cashbox')
    purchase = models.ForeignKey(PurchaseRequest, on_delete=models.SET_NULL,
                                 related_name='purchase_transaction', null=True, verbose_name='Purchase')
    sale_product = models.ForeignKey(SaleProduct, on_delete=models.SET_NULL,
                                     related_name='cashbox_sale', null=True, verbose_name='SaleProduct')
    sale_order = models.ForeignKey(SaleOrder, on_delete=models.SET_NULL,
