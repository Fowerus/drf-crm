# Generated by Django 4.0.1 on 2022-02-02 16:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='order_product_order', to='Orders.order', verbose_name='Order')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='organization_product_order', to='Organizations.organization', verbose_name='Organization')),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product_product_order', to='Market.product', verbose_name='Product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cashbox', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cashbox_purchase_request', to='Market.cashbox', verbose_name='Cashbox')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='organization_purchase_request', to='Organizations.organization', verbose_name='Organization')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='product_purchase_request', to='Market.product', verbose_name='Product')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='service_purchase_request', to='Organizations.service', verbose_name='Service')),
            ],
            options={
