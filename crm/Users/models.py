...
class UserManager(BaseUserManager):
	def _create_user(self, surname, name, patronymic, email = None, number = None, address = None, password = None, **extra_fields):
		if not email is None:
			email = self.normalize_email(email)
		user = self.model(surname = surname, name = name, patronymic = patronymic, address = address, email = email, number = number, **extra_fields)
	...
	def create_user(self, surname, name, patronymic, email = None, number = None, address= None, password = None, **extra_fields):
		extra_fields.setdefault('is_staff', False)
		extra_fields.setdefault('is_superuser', False)

		return self._create_user(surname = surname, name = name, patronymic = patronymic, address = address, email = email,number = number, password = password, **extra_fields)


	def create_superuser(self, surname, name, patronymic, email = None, number = None, address= None, password = None, **extra_fields):
...
class User(AbstractBaseUser, PermissionsMixin):
	...
	def _check_confirmed(self):
		return bool(self.confirmed_number or self.confirmed_email)
