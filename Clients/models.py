...
class Client(AbstractBaseUser):
    surname = models.CharField(
        max_length=150, verbose_name='Surname', blank=True)
    first_name = models.CharField(max_length=150, verbose_name='First name')
    second_name = models.CharField(
        max_length=150, verbose_name='Second name', blank=True)
    ...
    organization = models.ManyToManyField(
        Organization, related_name='organization_clients', verbose_name='Organization')
...
class ClientCard(MainMixin):
    client = models.ForeignKey(Client, on_delete=models.SET_NULL,
                               related_name='client_client_card', null=True, verbose_name='Client')
