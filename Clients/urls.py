...
urlpatterns = [
    ...
    path('client-card-l/<int:organization>/p=<str:phone>/', views.ClientCardListAPIView.as_view(), name = 'client_card_phone'),
    path('client-card-l/<int:organization>/f=<str:fio>/', views.ClientCardListAPIView.as_view(), name = 'client_card_fio'),
    ...
    path('client-card-ud/<int:id>/', views.ClientCardUpdateAPIView.as_view(), name = 'client_card_u'),
]
