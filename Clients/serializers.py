...
class ClientSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Client
		fields = ['id', 'surname', 'first_name', 'second_name', 'phone', 'address', 'confirmed_phone', 'organization', 'created_at', 'updated_at']
...
class ClientCardSerializer(serializers.ModelSerializer):
	...
	class ClientCardCSerializer(serializers.ModelSerializer):
		...
		class Meta:
			model = ClientCard
			fields = ['surname', 'first_name', 'second_name', 'phone', 'address', 'organization']
	...
	class ClientCardUSerializer(serializers.ModelSerializer):
		...
		class Meta:
			model = ClientCard
			fields = ['surname', 'first_name', 'second_name', 'phone', 'address', 'links']
			

	class Meta:
		model = ClientCard
		fields = ['id', 'surname', 'first_name', 'second_name', 'phone', 'address', 'organization', 'client', 'created_at', 'updated_at']
		...
		try:
			...
			if client.check_password(password):
				try:
					...
					session = Session_client.objects.create(client = client, device = device)
