...
urlpatterns = [
    ...
    path('mproduct-r/<str:_id>/<int:organization>/',
    ...
    path('mbusket-l/<int:organization>/',
         views.MBusketListAPIView.as_view(), name='mbusket_l'),
    path('mbusket-mcourier-l/<str:_id>/<int:organization>/',
         views.MBusketMCourierListAPIView.as_view(), name='mbusket_courier_l'),
    path('mbusket-r/<str:_id>/<int:organization>/',
    ...
    path('mcourier-l/<int:organization>/',
         views.MCourierListAPIView.as_view(), name='mcourier_l'),
    path('mcourier-morder-l/<int:organization>/',
